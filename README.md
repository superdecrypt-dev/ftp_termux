...
```bash
wget https://raw.githubusercontent.com/superdecrypt-dev/ftp_termux/main/ftp_termux.py
```

Atau:

```bash
curl -O https://raw.githubusercontent.com/superdecrypt-dev/ftp_termux/main/ftp_termux.py
```
